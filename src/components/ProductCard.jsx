...
const ProductCard = (props) => {  
  ...
  return (
    <div className='col col-lg-3 text-center'>
            ...
            <h4 className="d-flex">Rating: </h4> <Rating className='' initialValue={rating?.rate} /> 
            <button type="button" className="btn btn-primary" onClick={()=> handleAddProduct(data)}>Add</button>
    </div>
  )
}
